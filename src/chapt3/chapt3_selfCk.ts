const myArray: number[] = [1, 3, 5, 6, 8, 9, 15];
...
const myArray2: number[] | string[] = [];
myArray2[10] = "test";
console.log(myArray2); // returns the array with empty intems except for the last index position
console.log(myArray2[2]); // returns undefined because the index postion is empty

const myArray3: number[] = [3, 6, 8, 9, 3, 55, 553, 438];
myArray3.sort();
